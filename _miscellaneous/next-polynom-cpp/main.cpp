...
int solve()
{
    len = addOne(num, len); // To ignore polyndromes in input
    if (!isPolyndrome(num)) { // Check for 999...99 case immediately, so we guarantee that len will not change
